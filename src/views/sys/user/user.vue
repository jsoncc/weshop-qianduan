<template>
  <div>
    ...
    <!--第二行 增加搜索功能-->
    <el-row class="search">
        <el-col :span="5"><el-input placeholder="请输入用户名称" size="small" v-model="filter.oil_name"></el-input></el-col>
        <el-col :span="1"></el-col>
        <el-col :span="5"><el-input placeholder="请输入用户地址" size="small" v-model="filter.address"></el-input></el-col>
         <el-col :span="1"></el-col>
        <el-col :span="5">
    ...
    <el-table stripe border v-bind:data="data" style="width: 100%">
      ...
      <el-table-column label="用户名" header-align="center" prop="username">
      </el-table-column>
      <el-table-column label="姓名" header-align="center" prop="name" width="300">
      </el-table-column>
      <el-table-column width="150" header-align="center" label="性别">
      ...
      <el-table-column prop="mobile" width="150" header-align="center" align="center" label="手机号">
      </el-table-column>
    ...
    <!--添加或修改-->
    <user-save-update ref="saveOrUpdate" :visible.sync="isshow"  @refeshData="initData" ></user-save-update>
  </div>
</template>
